...
describe("Comment Service Unit Tests", () => {
  ...
  describe("Successful Operations", () => {
    ...
    it("should get a comment by ID", async () => {
      const mockComment = {
        ...
        bugid: 1,
        userid: 1,
        commenttext: "This is a critical bug",
        createdat: new Date("2025-10-30T14:30:00Z"),
        username: "testuser"
      };
  ...
  describe("Error Cases", () => {
    ...
    it("should fail to create comment without data", async () => {
      await expect(CommentServices.createComment(null as any)).rejects.toThrow("Please provide comment data");
    });
    ...
    it("should fail to create comment with missing required fields", async () => {
      ...
      await expect(CommentServices.createComment(incompleteData as any)).rejects.toThrow(
    ...
    it("should fail to create comment with invalid field types", async () => {
      ...
      await expect(CommentServices.createComment(invalidData as any)).rejects.toThrow(
    ...
    it("should fail to update comment without data", async () => {
      await expect(CommentServices.updateComment(1, null as any)).rejects.toThrow("No update data provided");
    });
